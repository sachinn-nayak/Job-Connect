			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
						<a href="./"><img src="images/Preview1.jpg" alt="Logo" /></a>						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Moodbidri, <br/> PO.BOX AX40, <br/>Alva's College</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:mailto:JobConnect2k24.com">JobConnect2k24@gmail.com</a>
								</li>

								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+91 63644 97927</a>
								</li>
