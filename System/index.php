...
<head>
	...
	<title>JobConnect- Job Portal</title>
  ...
  <style>
	...
	@keyframes gradient-animation {
        ...
        .hero {
            background: linear-gradient(45deg, #FFC371, #FF5F6D, #6B45E3);
  ...
  /* Define keyframe animation for form wrapper */
  @keyframes fadeIn {
    0% {
      opacity: 0;
    }
  ...
  /* Apply animation to the hero text */
  .hero h1, .hero p {
    animation: slideInFromLeft 1s ease forwards;
  }

  /* Apply animation to the main search form wrapper */
...
<body class="home"  >
	...
	<div class="container-wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container" >
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/Preview1.jpg" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper" id="mybody">
		
			<div class="hero" id="myimg" style="background-image:url('images/hero-header/img1.jpg'); ">
			
				<div class="container" >

					<h1>Explore Your Next Career Move</h1>
					<p>Finding your next job or career on JobConnect</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About JobConnect</h5>
											<p>JobConnect is a job portal, online job management system developed by Alva's Bca students for theire project in April 2024.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title"> JobConnect Contact</h5>
								
								<p>Address : Alva's College Moodbidri</p>
								<p>Email : <a href="mailto:JobConnect2k24.com">JobConnect2k24.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> JobConnect Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by 1.Raed 2.Vithin 3.Ashwij 4.Sachin</a></li>
								</ul>
